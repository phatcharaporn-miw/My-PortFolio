    ...
    <>
      ...
      >
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          {/* Heading */}
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16 reveal fade-up">
            ...
            <p className="text-base md:text-lg text-secondary max-w-xl mx-auto leading-relaxed">
              Fresh graduate, real experience, and eager to grow. Feel free to
              reach out — I'd love to hear from you.
            </p>
          </div>

          {/* Contact Cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 reveal fade-up">
            {contacts.map((c) => (
              <button
                key={c.label}
                onClick={() =>
